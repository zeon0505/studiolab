                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($bookings as $booking)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                @php $firstHItem = $booking->items->first(); @endphp
                                @if($booking->items->count() > 0)
                                    ...
                                    <div class="flex items-center gap-1.5 mt-1">
                                        <span class="px-2 py-0.5 rounded-md text-[10px] font-semibold bg-teal-50 text-teal-700 border border-teal-100 uppercase">{{ $firstHItem->kategori }}</span>
                                        <span class="px-2 py-0.5 rounded-md text-[10px] font-semibold bg-slate-100 text-slate-500 uppercase">{{ $firstHItem->tipe }}</span>
                                    </div>
                                    @endif
                                @else
