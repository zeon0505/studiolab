...
<div id="modal-add" class="hidden fixed inset-0 z-50 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                @else
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="number" name="kapasitas_kursi" value="0" min="0" required class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-[13px] focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Kapasitas kursi bioskop">
                    </div>
                @endif
            </div>
...
function initEditItem(btn) {
    ...
    document.getElementById('edit-form').action = `/admin/items/${id}/update`;
